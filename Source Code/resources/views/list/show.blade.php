...
<div class="container-lg">
    <section class="py-100" data-list="{{ $list->id }}" id="list_show">
        <div class="row">
            @include('list.partials.top_part')
        </div>
        ...
        <div class="row" id="single-content">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12">
                        @foreach ($list->latestPosts as $post)
                        <div class="card">
                            ...
                            <div class="post-image">
                                <img class="img-fluid card-img"
                                    src="{{ route('image.post', ['filename' => $post->post_image]) }}" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="card-body" data-post="{{ $post->id }}">
                                ...
                                <div class="dropdown" id="content-dropdown">
                                    <button type="button" class="btn no-focus btn-sm" id="post_button"
                ...
                <div class="all-comments">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @empty
                            <p class="m-0">This list has no comments</p>
                            @endforelse
                        </div>
