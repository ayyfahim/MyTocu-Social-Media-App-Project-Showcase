...
<section class="py-100">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="custom mb-5">Edit Journal</h1>
        </div>
    </div>
    <div class="edit-block">
        <form id="edit-account" class="custom" role="form" method="POST"
            action="{{ route('journal.update', $journal->slug) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                            style="height: 300px;">{{ $journal->description }}</textarea>
                        @error('description')
